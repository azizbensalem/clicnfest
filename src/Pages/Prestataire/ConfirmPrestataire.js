...
import { removePrestataire, subtractQuantityPrestataire, 
addQuantityPrestataire } from '../../Data/actions/prestataireActions';
...
const ConfirmPrestataire = ({ image, titre, volume, type, prix, description, quantity, id , page}) => {
    ...
    const handleAddQuantity = (id) => {
        dispatch(addQuantityPrestataire(id));
    };
    const handleSubtractQuantity = (id) => {
        dispatch(subtractQuantityPrestataire(id));
    };
...
export default ConfirmPrestataire;