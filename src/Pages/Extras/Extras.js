...
import PrestataireImage from "../../Images/Extras.png";
import Pagination from "@material-ui/lab/Pagination";
import ProductPrestataire from "./ProductPrestataire";
...
export const Extras = () => {
      ...
      const data = useSelector((state) => state.prestataire.items);
      useEffect(() => {
        const results = data.filter((item) =>
          item.nom_prestataire.toString().toLowerCase().includes(searchTerm)
        );
      ...
      <div>
        ...
        <div>
          ...
          <div
            ...
            style={{
              backgroundImage: `url(` + PrestataireImage + `)`,
            }}
          >
